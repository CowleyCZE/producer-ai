...
class AiProducerService(private val context: Context) {
 ...
 // Funkce pro zkopírování modelu z assets do mezipaměti s kontrolou integrity
 private fun copyModelFromAssets(modelName: String): File {
 val modelFile = File(context.cacheDir, modelName)
 
 // Pokud soubor existuje, ale je menší než 100 MB, je to pravděpodobně Git LFS pointer nebo poškozený soubor
